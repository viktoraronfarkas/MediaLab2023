  ...
  return (
    <SafeAreaView style={{ backgroundColor: theme.colors.backgroundSand, flex: 1 }}>
        ...
        <View style={{ marginTop: 20, marginBottom: 20, alignItems: 'center' }}>
            <Image source={glitterImage} style={{ width: 30, height: 50, position: 'absolute', top: -30, left: 320, right: 20, bottom: 20 }} />
            <Image source={heartLeftImage} style={{ width: 60, height: 50, position: 'absolute', top: 50, left: 20, right: 100, bottom: 20 }} />
            <Image source={starImage} style={{ width: 22, height: 30, position: 'absolute', top: 10, left: 50, right: 100, bottom: 20 }} />

            <ImageBackground source={circleLineImage} style={{ width: 240, height: 80 }}>
                <Text style={[styles.headline1, { textAlign: 'center', marginTop: 20 }]}>
                    [StudyProgram]
                </Text>
            </ImageBackground>
        </View>
